...
util.extend(JsonRpcError, Error);
util.extend(ParseError, JsonRpcError);
util.extend(InvalidRequestError, JsonRpcError);
util.extend(MethodNotFoundError, JsonRpcError);
util.extend(InvalidParamsError, JsonRpcError);
